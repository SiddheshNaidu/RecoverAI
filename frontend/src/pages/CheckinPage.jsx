...
export default function CheckinPage() {
 ...
 "2px 2px 6px rgba(27, 67, 50,0.5), inset 0 2px 4px rgba(0,0,0,0.2)")
 }
 onMouseUp={(e) =>
 (e.currentTarget.style.boxShadow =
 "6px 6px 16px rgba(27, 67, 50,0.4), -3px -3px 10px rgba(82, 183, 136,0.3), inset 0 1px 0 rgba(255,255,255,0.15)")
 ...
 style={{
 boxShadow:
 "4px 4px 12px rgba(27, 67, 50,0.35), -2px -2px 6px rgba(82, 183, 136,0.25), inset 0 1px 0 rgba(255,255,255,0.15)",
 }}
 >
 Submit to AI
 </button>
